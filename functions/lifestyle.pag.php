...
$sql = "SELECT * FROM posts WHERE topic='lifestyle' ORDER BY id DESC LIMIT $start_from, $record_per_page";
...
';
// Pagination
$page_query = "SELECT * FROM posts WHERE topic='lifestyle' ORDER BY id ASC";
