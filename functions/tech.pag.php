...
$sql = "SELECT * FROM posts WHERE topic='tech' ORDER BY id DESC LIMIT $start_from, $record_per_page";
            ...
            <div class="d-flex mb-3">
                ...
                <div class="w-100 d-flex flex-column justify-content-center bg-light px-3" style="height: 100px;">
                    <div class="mb-1" style="font-size: 13px;">
                        <a href="'.$row['topic'].'.php">Technology</a>
...
';
// Pagination
$page_query = "SELECT * FROM posts WHERE topic='tech' ORDER BY id ASC";
