<?php
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="javascript:void(0)">Gadgets</a></li>
                <li class="nav-item"> <a class="nav-link" href="javascript:void(0)">Real Estate Realtor</a></li>
                <li class="nav-item"> <a class="nav-link" href="javascript:void(0)">Affiliate Marketing</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#gadgets" aria-expanded="false" aria-controls="gadgets">
              <span class="menu-icon">
                <i class="mdi mdi-cart"></i>
              </span>
              <span class="menu-title">SG Market</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="gadgets">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="javascript:void(0)">Add Item</a></li>
                <li class="nav-item"> <a class="nav-link" href="javascript:void(0)">All Items</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" data-toggle="collapse" href="#real" aria-expanded="false" aria-controls="real">
              <span class="menu-icon">
                <i class="mdi mdi-home"></i>
              </span>
              <span class="menu-title">TSD Property</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="real">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="http://localhost/S.G%20Enterprices/SGAdmin/real_estate/rent_home/upload_home/shortcut_houseForRent.php?page=uploadHouseForRent&profession=<?= $profession ?>&email=<?= $email ?>">Add House For Rent</a></li>
                <li class="nav-item"> <a class="nav-link" href="http://localhost/S.G%20Enterprices/SGAdmin/real_estate/buy_home/upload_home/shortcut_houseForSale.php?page=uploadHouseForSale&profession=<?= $profession ?>&email=<?= $email ?>">Add House For Sale</a></li>
                <li class="nav-item"> <a class="nav-link" href="http://localhost/S.G%20Enterprices/SGAdmin/real_estate/shortcut_tsdProperty.php?page=TSDProperty&profession=<?= $profession ?>&email=<?= $email ?>">TSD Property</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="#">Real Estate Realtor</a></li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="real">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="#">Add Real Estate Realtor</a></li>
                <li class="nav-item"> <a class="nav-link" href="#">All Real Estate Realtors</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="blog">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="javascript:void(0)">Add Blog</a></li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="gadgets">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="javascript:void(0)">Add Gadget</a></li>
                <li class="nav-item"> <a class="nav-link" href="javascript:void(0)">All Gadgets</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="jaavascript:void(0);">
              <span class="menu-icon">
                <i class="mdi mdi-inbox-multiple"></i>
              </span>
              <span class="menu-title">Inboxs</span>
